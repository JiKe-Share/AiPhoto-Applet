...
<div class="content">
    <p class="desc">
        使用过程中遇到任何问题可联系我们
        <a href="https://www.jikebox.cn" target="_blank">微信联系：code0223</a>
        <a href="tencent://message/?uin=27658525&Site=&Menu=yes">QQ联系</a>
    </p>
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="database" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据库名称" placeholder="请输入数据库名称" value="AiPhoto">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="prefix" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据表前缀" placeholder="请输入数据表前缀" value="ai_">
                </div>
            </div>
        ...
        <div class="bg">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" id="admin_url" name="admin_url" autocomplete="off" lay-verify="required" lay-reqtext="请输入后台的地址" value="admin">
                ...
                success: function (data) {
                    ...
                    if (data.code === 1) {
                        layer.msg(data.msg, {icon: 1}, function () {
                            window.location.href = location.protocol + '//' + location.host + '/' + data.url +'/login/index.html';
                        });
                    } else {
