...
class AipFace extends AipBase {
    ...
    /**
     * 人脸编辑 editattr api url
     * @var string
     */
    private $editattrUrl = 'https://aip.baidubce.com/rest/2.0/face/v1/editattr';
    ...
    // 人脸编辑接口
 public function editattr($image, $actionType,$target=0, $qualityControl='NORMAL',$imageType='BASE64',$options=array()){
        ...
        return $this->request($this->editattrUrl, json_encode($data),  array(
